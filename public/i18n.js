...
export const TEXTES = {
  fr: {
    ...
    'avis':             'Le modèle tourne sur un processeur partagé et gratuit : comptez 20 à 40 secondes par traduction, et jusqu’à deux minutes pour la toute première si le service sortait de veille. Une seule traduction à la fois.',
    ...
    'etat.longue':      'Toujours en cours… le service sortait sans doute de veille.',
